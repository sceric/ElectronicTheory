...
/*** NOTE:
     Example taken from the excellent RealTimeClockDS1307 library by David H. Brown:
	 (https://github.com/davidhbrown/RealTimeClockDS1307).
	 The example has been modified to be compatible with the layout suggested by Adafruit
	 to power the DS1307-based RTC directly from the Arduino Analog pins:
	 (http://www.ladyada.net/learn/breakoutplus/ds1307rtc.html).
	 Enriched the help section with some more useful info.
	 This example will be used to have a simple way to set-up date/time of DS1307-based RTC.
***/
