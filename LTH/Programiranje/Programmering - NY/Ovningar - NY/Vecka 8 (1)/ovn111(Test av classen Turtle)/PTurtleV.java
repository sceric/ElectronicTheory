...
//import se.lth.cs.pt.turtle.*; vi ska inte iportera någonting pga vi har nu
//egen class som ligger i samma map!!!!!!!!
	...
	public static void main(String[]arg){
	  ...
	  while(!finish){                       //finish är false...tills inte blir
		  ...
		  for(int k=1; k<=n;k++){			// true kär man
		   	  ...
		   	  if(t[k].getX()>=450 ){        //när sjölpadda nå 445 är i mål då
